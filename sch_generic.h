...
*
*Based on origin Generic packet scheduler routines  
...
static inline int qdisc_enqueue_head(struct sk_buff *skb, struct Qdisc *sch)
{
	return __qdisc_enqueue_head(skb, sch, &sch->q);
}
